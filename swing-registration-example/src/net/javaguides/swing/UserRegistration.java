...
public class UserRegistration extends JFrame {
    ...
    public UserRegistration() {
        ...
        email.setFont(new Font("Times New Roman", Font.PLAIN, 30));
        ...
        mob = new JTextField();
        mob.setFont(new Font("Times New Roman", Font.PLAIN, 30));
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/swing_demo", "root", "Deva@2002");
